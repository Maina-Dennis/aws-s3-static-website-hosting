...
> See `screenshots/static-website-architecture.png` for the full visual reference.
...
| View | Description |
|---|---|
| ![Architecture](screenshots/static-website-architecture.png) | Multi-region S3 architecture with Cross-Region Replication |
